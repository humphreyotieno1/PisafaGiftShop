          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <p className="mt-4 max-w-xs text-sm text-primary-foreground/80">
                Your premier destination for exquisite jewelry and accessories.
              </p>
              <div className="mt-6 flex space-x-4">
                <a href="#" className="rounded-full bg-primary-foreground/10 p-2 text-primary-foreground hover:bg-primary-foreground/20" aria-label="Facebook">
                  <Facebook className="h-5 w-5" />
                </a>
                <a href="#" className="rounded-full bg-primary-foreground/10 p-2 text-primary-foreground hover:bg-primary-foreground/20" aria-label="Twitter">
                  <Twitter className="h-5 w-5" />
                </a>
                <a href="#" className="rounded-full bg-primary-foreground/10 p-2 text-primary-foreground hover:bg-primary-foreground/20" aria-label="Instagram">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-sm text-primary-foreground/80">Equity Trading Centre, Nairobi, Kenya</span>
                </li>
